...
I:"ytp-miniplayer-ui"});this.Ag=!1;this.player=a;this.K(a,"minimized",this.Hi);this.K(a,"onStateChange",this.IP)},Q5=function(a){g.AS.call(this,a);
...
g.k.show=function(){this.hd=new g.nn(this.Ro,null,this);this.hd.start();if(!this.Ag){this.tooltip=new g.o_(this.player,this);g.C(this,this.tooltip);g.jP(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.Ab=new g.XX(this.player);g.C(this,this.Ab);this.Oj=new g.V({D:"div",I:"ytp-miniplayer-scrim"});g.C(this,this.Oj);this.Oj.Y(this.element);this.K(this.Oj.element,"click",this.MD);var a=new g.V({D:"button",da:["ytp-miniplayer-close-button","ytp-button"],O:{"aria-label":"Close"},L:[g.fN()]});
g.C(this,a);a.Y(this.Oj.element);this.K(a.element,"click",this.Jm);a=new O5(this.player,this);g.C(this,a);a.Y(this.Oj.element);this.kk=new g.V({D:"div",I:"ytp-miniplayer-controls"});g.C(this,this.kk);this.kk.Y(this.Oj.element);this.K(this.kk.element,"click",this.MD);var b=new g.V({D:"div",I:"ytp-miniplayer-button-container"});g.C(this,b);b.Y(this.kk.element);a=new g.V({D:"div",I:"ytp-miniplayer-play-button-container"});g.C(this,a);a.Y(this.kk.element);var c=new g.V({D:"div",I:"ytp-miniplayer-button-container"});
g.C(this,c);c.Y(this.kk.element);this.jE=new g.qZ(this.player,this,!1);g.C(this,this.jE);this.jE.Y(b.element);b=new g.nZ(this.player,this);g.C(this,b);b.Y(a.element);this.nextButton=new g.qZ(this.player,this,!0);g.C(this,this.nextButton);this.nextButton.Y(c.element);this.Wg=new g.d_(this.player,this);g.C(this,this.Wg);this.Wg.Y(this.Oj.element);this.Ec=new g.uZ(this.player,this);g.C(this,this.Ec);g.jP(this.player,this.Ec.element,4);this.Ur=new g.V({D:"div",I:"ytp-miniplayer-buttons"});g.C(this,this.Ur);
g.jP(this.player,this.Ur.element,4);a=new g.V({D:"button",da:["ytp-miniplayer-close-button","ytp-button"],O:{"aria-label":"Close"},L:[g.fN()]});g.C(this,a);a.Y(this.Ur.element);this.K(a.element,"click",this.Jm);a=new g.V({D:"button",da:["ytp-miniplayer-replay-button","ytp-button"],O:{"aria-label":"Close"},L:[g.sN()]});g.C(this,a);a.Y(this.Ur.element);this.K(a.element,"click",this.LN);this.K(this.player,"presentingplayerstatechange",this.Kb);this.K(this.player,"appresize",this.La);this.K(this.player,
...
g.k.LN=function(){this.player.playVideo()};
g.k.MD=function(a){if(a.target===this.Oj.element||a.target===this.kk.element)g.R(this.player.N().experiments,"kevlar_miniplayer_play_pause_on_scrim")?g.aL(g.sI(this.player))?this.player.pauseVideo():this.player.playVideo():this.player.la("onExpandMiniplayer")};
...
g.k.Ro=function(){this.Bd();this.hd&&this.hd.start()};
g.k.Kb=function(a){g.T(a.state,32)&&this.tooltip.hide()};
g.k.La=function(){this.Ec.setPosition(0,g.LG(this.player).getPlayerSize().width,!1);this.Ec.ly()};
g.k.IP=function(a){this.player.app.visibility.o&&(0===a?this.hide():this.show())};
